...
public class Keyword extends Token {
    ...
    public static Keyword typeBool() {
        return new Keyword(Lex.TYPE_BOOL);
    }
    ...
    public static Keyword typeInt() {
        return new Keyword(Lex.TYPE_INTEGER);
    }
    ...
    public static Keyword typeRecord() {
        return new Keyword(Lex.TYPE_RECORD);
    }
    ...
    public static Keyword typeArray() {
        return new Keyword(Lex.TYPE_ARRAY);
    }
    ...
    public static Keyword symProcedure() {
        return new Keyword(Lex.PROCEDURE);
    }
    ...
    public static Keyword symWriteln() {
        return new Keyword(Lex.WRITELN);
    }
}
